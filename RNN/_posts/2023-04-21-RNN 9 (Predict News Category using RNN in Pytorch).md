---
tag: [Deep Learning, 딥러닝, RNN, 자연어처리, 순환신경망, pytorch, 파이토치, AG News Dataset]
toc: true
toc_sticky: true
toc_label: 목차
...
![png](/assets/images/2023-04-21-RNN 9 (Predict News Category using RNN in Pytorch)/output_52_0.png)
